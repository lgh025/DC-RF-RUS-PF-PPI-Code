...
dataN=cell(1,10);
labelN=cell(1,10);
numN=cell(1,10);%split 10
N1=cell(1,10);
testN=cell(1,10);
test_labelN=cell(1,10);
data_n_save=cell(1,10);
test_label_score1=cell(1,10);
test_data_score1=cell(1,10);
test_label_score2=cell(1,10);
test_data_score2=cell(1,10);
test_label_scoreP2=cell(1,10);
test_data_scoreP2=cell(1,10);
test_label_scoreN2=cell(1,10);
test_data_scoreN2=cell(1,10);
test_label_scoreP1=cell(1,10);
test_data_scoreP1=cell(1,10);
test_label_scoreN1=cell(1,10);
test_data_scoreN1=cell(1,10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
for k=1:10
for i=1:1604
  ii=10*(i-1)+k;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
 ...
 order=0;
     for j=1:size(data1,1)
      ...
      test_number_store1=cell(1,10);
      test_number_del2=cell(1,10);
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5555
     for k=1:10
          test{k}=testDATA1;
      dataN{k}= data_n{k} ;
